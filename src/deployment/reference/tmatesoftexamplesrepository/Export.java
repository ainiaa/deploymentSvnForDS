 ...
 * ====================================================================
 */
package deployment.reference.tmatesoftexamplesrepository;
...
public class Export {
    ...
    private static class ExportEditor implements ISVNEditor {
        ...
        public void applyTextDelta(String path, String baseChecksum) throws SVNException {
            File baseFile = null;
            myDeltaProcessor.applyTextDelta(baseFile, new File(myRootDirectory, path), false);
        }
        ...
        @Override
        public void changeDirProperty(String string, SVNPropertyValue svnpv) throws SVNException {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }

        @Override
        public void changeFileProperty(String string, String string1, SVNPropertyValue svnpv) throws SVNException {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }

        private void File(File myRootDirectory, String path) {
            throw new UnsupportedOperationException("Not supported yet."); //To change body of generated methods, choose Tools | Templates.
        }
    }
