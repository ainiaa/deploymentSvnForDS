...
public class SVNUtil {
     ...
     *
     * @param clientManager
     * @param localPath a local unversioned directory or singal file that will
     * be imported into a repository;
     * @param dstURL a repository location where the local unversioned
     ...
     * SVN client's 'svn status' command), otherwise false
     * @return
     */
     ...
     *
     * @param clientManager
     * @param url a repository location from where a Working Copy will be
     * checked out
     * @param revision the desired revision of the Working Copy to be checked
     * out
