package deployment.reference.svnkitloli;
...
public class SVNKitUtil {
     ...
     * 将修改提交到服务器
     *
     * @param wcPath 需要提交的文件/文件夹
     * @param keepLocks 是否加锁
     * @param commitMessage 消息
     * @return 此次提交的信息
     * @throws SVNException
     */
     ...
     * 将本地文件夹更新到指定revision
     *
     * @param wcPath 需要更新的文件夹
     * @param updateToRevision 更新到的revision
     * @param isRecursive 是否递归
     * @return 更新后的revision
     * @throws SVNException
     */
     ...
     *
     * @param wcPath 本地地址
     * @param url 服务器上的文件夹地址
     * @param updateToRevision 需要更新到的revision
     * @param isRecursive 是否递归
     * @return 更新后的revision
     * @throws SVNException
     */
     ...
     * 创建本地文件夹和文件
     *
     * @param aNewDir 需要创建的文件夹
     * @param localFiles 需要创建的文件
     ...
     * @throws SVNException
     */
    public SVNCommitInfo createBranchOrTag(SVNURL originURL, SVNURL dstURL) throws SVNException {
        String message = "copy " + originURL + " to " + dstURL;
        return cm.getCopyClient()
                .doCopy(new SVNCopySource[]{new SVNCopySource(
                            SVNRevision.HEAD, SVNRevision.HEAD,
                            originURL)}, dstURL, false,
                true, false, message, new SVNProperties());
    }
