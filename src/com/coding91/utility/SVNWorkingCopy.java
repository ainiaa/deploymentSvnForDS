...
public final class SVNWorkingCopy {
    ...
    public SVNWorkingCopy(SVNClientManager clientManager) {
        setupLibrary();
    ...
    public SVNCommitInfo makeDirectory(SVNURL[] urlArray, String commitMessage) throws SVNException {
        /*
         * Returns SVNCommitInfo containing information on the new revision committed 
         * (revision number, etc.) 
         */
        return clientManager.getCommitClient().doMkDir(urlArray, commitMessage);
    }
    ...
    public Map<String, Date> getBranchOrTagListByEnvConf(String rootUrl) throws SVNException {
    ...
    public Map<String, Date> getLatestBranchOrTagByEnvConf(String rootUrl) throws SVNException {
        SVNURL svnUrl = SVNURL.parseURIEncoded(rootUrl);
     ...
     * @throws SVNException
     */
    public SVNCommitInfo createBranchOrTagBySvnUrl(String svnUrl, String originTag, String dstTag, String commitMessage, int version) throws SVNException {

        SVNURL srcURL = SVNURL.parseURIEncoded(svnUrl + originTag);
        SVNURL dstURL = SVNURL.parseURIEncoded(svnUrl + dstTag);
     ...
     */
    public static void createLocalDir(File aNewDir, File[] localFiles, String[] fileContents) {
        if (!aNewDir.mkdirs()) {
